...
package com.android.settings.pixys.fragments;
...
public class ClockDateSettings extends SettingsPreferenceFragment
    ...
    public void onResume() {
        ...
        final boolean hasNotch = PixysUtils.hasNotch(getActivity());
        final int notchType = PixysUtils.getCutoutType(getActivity());
